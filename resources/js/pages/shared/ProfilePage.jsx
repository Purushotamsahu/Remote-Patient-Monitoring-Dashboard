    ...
    return (
        <div className="max-w-2xl mx-auto space-y-6 p-6">
            ...
            <div className="card p-6 flex items-center gap-5">
                <div className={`w-20 h-20 bg-gradient-to-br ${avatarGrad} rounded-2xl flex items-center justify-center text-white text-3xl font-black shadow-lg flex-shrink-0`}>
